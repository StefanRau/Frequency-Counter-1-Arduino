...
public:
	...
	/// Constructor
	/// </summary>
	/// <param name="iSettingsAddress">Address of the EEPROM for storing the current value, if -1, then this value is ignored</param>
	ProjectBase(int iSettingsAddress);
